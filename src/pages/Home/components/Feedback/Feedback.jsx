...
import instagram from "assets/png/icon-instagram.png";
import telegram from "assets/png/icon-telegram.png";
import twitter from "assets/png/icon-twitter.png";
			...
			<div className="container">
				...
				<div className={s.wrapper}>
					<div className={`${s.item} box`}>
						...
						<p className={s.text}>
							“I recently came across this cryptocurrency website which has been incredibly helpful in guiding me. The
							site is convenient and easy to navigate.”
						</p>
					...
					<div className={`${s.item} box`}>
						...
						<p className={s.text}>
							“Your courses helped me a lot! The manager was quick to help me with some questions and now I finally
							understand the blockchain and can work with data.”
						</p>
					...
					<div className={`${s.item} ${s.itemBottom} box`}>
						...
						<p className={s.text}>
							“The news section was frequently updated with insightful analysis and breaking news, while the provided
							were incredibly useful for traders and investors.”
						</p>
